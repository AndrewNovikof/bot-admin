...
return [
    ...
    | Supported Params:
    |
    | - name: The *personal* name you woulåd like to refer to your bot as.
    |
    ...
    */
    'bots'                         => [
        ...
        'dailyBot' => [
            'username'  => 'VD_daily_bot',
            'token' => env('TELEGRAM_BOT_TOKEN_SECOND', 'YOU_SECOND_TOKEN'),
        ],
    ],
